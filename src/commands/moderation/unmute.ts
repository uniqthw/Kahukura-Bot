...
export default class UnmuteCommand implements Command {
    ...
    slashCommand = new SlashCommandBuilder()
        ...
        .addUserOption((option) =>
            option
                .setName("user")
                .setDescription("Specify the user you are un-timing out.")
                .setRequired(true)
        )
        .addStringOption((option) =>
            option
                .setName("reason")
                .setDescription(
                    "Please provide a justification for un-timing out this user."
                )
                .setRequired(true)
    ...
    async execute(interaction: ChatInputCommandInteraction): Promise<any> {
        ...
        try {
            ...
            return await interaction.editReply({
                content: `Failed to untimeout user or log: ${err}`
            });
        }
    }
}
